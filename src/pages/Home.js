    ...
    return (
        <div className='home-parent'>
            ...
            <div className='home-content'>
                ...
                <img alt="work-image" className='image-work' src={currentWork != null ? "https://joel-strapi-deploy.herokuapp.com" + work_list[currentWork].attributes.thumbnail.data.attributes.url : "http://localhost:1337" + work_list[work_list.length-1].attributes.thumbnail.data.attributes.url}></img>
